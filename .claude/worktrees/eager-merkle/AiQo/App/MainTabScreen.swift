...
struct MainTabScreen: View {
    ...
    @State private var currentLanguage = AppSettingsStore.shared.appLanguage
    ...
    private var tabBody: some View {
        TabView(selection: $tabRouter.selectedTab) {
            ...
            .tabItem {
                ...
                .accessibilityLabel(NSLocalizedString("accessibility.tab.home", value: "Home", comment: "Home tab accessibility"))
            }
            ...
            .tabItem {
                ...
                .accessibilityLabel(NSLocalizedString("accessibility.tab.gym", value: "Gym", comment: "Gym tab accessibility"))
            }
            ...
            .tabItem {
                ...
                .accessibilityLabel(NSLocalizedString("accessibility.tab.captain", value: "Captain", comment: "Captain tab accessibility"))
            }
        ...
        .onReceive(NotificationCenter.default.publisher(for: .appLanguageDidChange)) { _ in
            currentLanguage = AppSettingsStore.shared.appLanguage
        }
