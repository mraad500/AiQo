...
actor HealthKitService {
    ...
    func requestAuthorization() async throws -> Bool {
        ...
        // ===== Write Types =====
        // Only request write access for types the app explicitly writes via user action.
        // Requesting unnecessary writes (HRV, VO2 Max, resting HR) triggers App Store rejection.
        ...
        // Workouts (user-initiated workout sessions)
